...
# Логинимся на сервер и входим в базу данных:
# sudo -i -u postgres
# psql
# \c <DB_NAME> - подключимся к этой базе данных для осуществления с ней взаимодействия
# файлы с данным csv нужно перенести в папку кластера БД, для это найдем её:
# show data_directory;
